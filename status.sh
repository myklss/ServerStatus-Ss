...
Download_Server_Status_server(){
	cd "/tmp"
	wget -N --no-check-certificate "https://github.com/myklss/ServerStatus-Ss/archive/master.zip"
...
Download_Server_Status_client(){
	cd "/tmp"
	wget -N --no-check-certificate "https://raw.githubusercontent.com/myklss/ServerStatus-Ss/master/clients/status-client.py"
...
Set_password(){
	...
	read -e -p "(默认: admin):" password_s
	[[ -z "$password_s" ]] && password_s="admin"
	echo && echo "	================================================"
